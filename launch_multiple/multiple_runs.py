...
if __name__ == "__main__":
    ...
    #FIRST EXPIRMENT ELASTICNET #####
    print("First Expirment ElasticNet")
...
##########3
    ...
    ############ Second EXPIRMENT Ridge #####

    print("First Expirment Ridge")
    ...
    ############ Third EXPIRMENT Lasso #####

    print("First Expirment Lasso")
