...
if __name__ == "__main__":
    ...
    mlflow.pyfunc.log_model(
        ...
        artifacts=artifacts,
        code_path=["custom+metric+and+artifact.py"],
        conda_env=conda_env
   )

    #evaluation DF
    #_bullitan -> All the metrics from the default like r2, rmse
    ...
    #mase, rmse + squared diffrence -> lower the better
    #accrurecy + r2 -> greater the better
